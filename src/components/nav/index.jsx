          ...
          <li className="btn btn-ghost normal-case">
            <div className="dropdown dropdown-end">
              ...
              >
                <li>
                  {' '}
                  <Link href="/new/palette" className="flex font-semibold items-center active:bg-black">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                ...
                <li>
                  <Link href="/new/gradient" className="flex font-semibold items-center active:bg-black">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
